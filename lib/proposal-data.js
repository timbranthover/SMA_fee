...
export function normalizeProposalCandidate(candidate) {
  ...
  return {
    ...
    assetClass: cleanText(candidate.assetClass, candidate.category || "", 120),
    objective: cleanText(candidate.objective, candidate.assetClass || candidate.category || "Portfolio implementation", 240),
    benchmark: cleanText(candidate.benchmark, "Not specified", 120),
