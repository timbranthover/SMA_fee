...
const rules = {
  ...
  SMAs: ["primary", "minimum", "managerFee", "perf1", "risk", "assetClass", "liquidity"],
  ...
  "Managed Options": ["primary", "minimum", "annualFee", "perf1", "risk", "assetClass", "liquidity"],
...
export const CATEGORY_COLUMN_PRESETS = Object.freeze({
  ...
  SMAs: { Research: defaults.SMAs, Performance: ["primary", "perf1", "risk", "assetClass", "liquidity"], Risk: ["primary", "perf1", "risk", "assetClass", "liquidity"], "Cost & implementation": ["primary", "minimum", "managerFee", "liquidity", "risk"] },
  ...
  "Managed Options": { Research: defaults["Managed Options"], Performance: ["primary", "perf1", "risk", "assetClass", "liquidity"], Risk: ["primary", "perf1", "risk", "assetClass", "liquidity"], "Cost & implementation": ["primary", "minimum", "annualFee", "liquidity", "risk"] },
