...
export function createWealthRepository(dataset) {
  ...
  const householdEventsById = buildIdIndex(householdEventRecords, "householdEvents");
  ...
  return Object.freeze({
    ...
    listHouseholdEvents: (householdId) => householdEventsByHousehold.get(householdId) || EMPTY,
  });
}