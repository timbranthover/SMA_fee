...
export const FLAG_DEFINITIONS = Object.freeze({
  ...
  Sustainable: { owner: "Sustainable & Impact Investing", definition: "Classified under the sustainable investing framework.", color: "green", code: "sus" },
  "CIO Select": { owner: "Chief Investment Office", definition: "Designated through an illustrative CIO product-review process across eligible mutual funds, ETFs and SMAs.", color: "blue", code: "sel" },
  "Model Delivered": { owner: "Managed Solutions", definition: "Strategy is available through a model-delivery operating structure.", color: "purple", code: "mdl" },
...
export const PRIMARY_FLAGS = Object.freeze(["CIO House View", "Sustainable", "CIO Select", "Model Delivered", "Tax-Aware", "Direct Indexing"]);
...
export const CATALOG_VERSION = "2026-09-07-sma-identities";
