...
export function calculateProposalImpact(model, candidates = []) {
  ...
  if (model.usEquityAfterSale === null) notes.push("We will confirm the source position’s asset class before showing how this change affects US equity exposure.");
