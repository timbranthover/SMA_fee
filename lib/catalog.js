...
function makeSynthetic(category, index) {
  ...
  let type = equityReference ? referencedEquityType(referenceName, referenceTicker) : etfReference ? (/\bETN\b/i.test(etfName) ? "ETP" : /\bactive\b/i.test(etfName) ? "Active ETF" : "ETF") : pick(pool.types, seed, 1);
