...
export const MORRISON_WEALTH_DATASET = deepFreeze({
  ...
  insights: [
    { id: "concentration", householdId: HOUSEHOLD_ID, severity: "Priority", tone: "red", title: "Apple concentration increased to 23.4%", detail: "$2.80M across two taxable accounts", action: "Review" },
    { id: "cash", householdId: HOUSEHOLD_ID, severity: "Opportunity", tone: "green", title: "$740K available for investment", detail: "6.2% cash versus a 4% policy target", action: "Explore" },
    { id: "muni", householdId: HOUSEHOLD_ID, severity: "Allocation", tone: "blue", title: "Municipal bonds below policy range", detail: "6.1% current versus 10% target", action: "Explore" },
    { id: "capital-call", householdId: HOUSEHOLD_ID, severity: "Upcoming", tone: "amber", title: "$125K private-credit capital call", detail: "Due Sep 8 · funding source identified", action: "Review" },
    { id: "changes", householdId: HOUSEHOLD_ID, severity: "Research", tone: "slate", title: "Three followed investments changed", detail: "Two research reviews · one shelf update", action: "View" },
  ],
