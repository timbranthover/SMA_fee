...
const CATEGORY_SORTABLE_COLUMNS = Object.freeze({
  ...
  "Fixed Income": Object.freeze({
    primary: definition("primary", "Price"),
    trend: definition("trend", "1Y price return"),
  ...
  Alternatives: Object.freeze({
    ...
    trend: definition("trend", "1Y reported return"),
  ...
  Structured: Object.freeze({
    ...
    trend: definition("trend", "Since issue"),
  ...
  Annuities: Object.freeze({
    ...
    trend: definition("trend", "Illustrative growth"),
