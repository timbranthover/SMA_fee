...
export function sortLoadedItems(items, sort, category) {
  // The server sorts the full index before pagination. Reordering only the loaded
  // page by live quotes would make page boundaries (and visible sort values) lie.
  return items;
}
