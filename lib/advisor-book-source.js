...
function generatedHousehold(index) {
  ...
  if (cashPct >= 10) insights.push({ id: `${id}-cash`, householdId: id, severity: "Opportunity", tone: "green", title: `${moneyShort(cash)} available for investment`, detail: `${cashPct.toFixed(1)}% cash across the household`, action: "Explore" });
